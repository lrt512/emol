    ...
    def handle(self, *args, **options):
        ...
        if options['clear_cache']:
            ...
            try:
                ...
                all_keys = cache._cache.keys('throttle:*') if hasattr(cache._cache, 'keys') else []
                for key in all_keys:
                    cache.delete(key)
        ...
        for i in range(options['requests']):
            ...
            self.stdout.write(f"    Headers - Limit: {limit}, Remaining: {remaining}, Window: {window}")
        ...
        if throttled_count > 0:
            ...
            self.stdout.write("This suggests the throttling middleware is active and working")
        else:
